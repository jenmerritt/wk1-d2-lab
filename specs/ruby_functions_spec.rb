...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    test_volume_of_cube = volume_of_cube(1)
    assert_equal(1, test_volume_of_cube)
    #add test code here
  end
  #
  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    test_volume_of_sphere = volume_of_sphere(1)
    assert_equal(Math::PI, test_volume_of_sphere)
    #add test code here
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    test_fahrenheit_to_celsius = fahrenheit_to_celsius(32)
    assert_equal(0, test_fahrenheit_to_celsius)
    #add test code here
  end
